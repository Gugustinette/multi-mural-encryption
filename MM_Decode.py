message = "022660001660022660002650065550032660041660002650067560" #str(input("Enter a message to decode"))
key = "BADC-5211216" #str(input("Enter the key"))
...
original_message = Decrypt(message, key)
